...
if [ ! -e ${OPENSSL_ARCHIVE_FILE_NAME} ]; then
  ...
  VERSIONNUMBERNAME=${VERSION//./_}
  OPENSSL_ARCHIVE_URL="https://github.com/openssl/openssl/releases/download/OpenSSL_${VERSIONNUMBERNAME}/${OPENSSL_ARCHIVE_FILE_NAME}"
  echo $OPENSSL_ARCHIVE_URL
  ...
  curl ${CURL_OPTIONS} -L -O "${OPENSSL_ARCHIVE_URL}"
