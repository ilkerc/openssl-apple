...
if [ $FWTYPE == "dynamic" ]; then
    ...
    for TARGETDIR in `ls -d *.sdk`; do
        ...
        ld obj/*.o \
            ...
            -o $FWNAME.dylib \
            -ld_classic # https://youtrack.jetbrains.com/issue/KT-60230/Native-unknown-options-iossimulatorversionmin-sdkversion-with-Xcode-15-beta-3#focus=Comments-27-7828901.0-0
